...
public class UserServiceImplTest {
    ...
    public void getUserProfile_UnregisteredUser(String username, Long currUserId) throws UserNotFoundException {
        //Arrange
        ...
        when(userRepo.getUserProfileByUsername(username))
        ...
        UserNotFoundException exception =
                assertThrows(
                        ...
                        () -> userService.getUserProfile(username, currUserId)
                );
    ...
    public void checkUserExistenceByUsername_UnregisteredUser(String username) {
        ...
        UserNotFoundException exception = assertThrows(
                UserNotFoundException.class, () ->
                        userService.checkAndGetUserByUsername(username)
        );
    ...
    public void checkUserExistenceByUserId_UnregisteredUser(Long userId) {
        ...
        UserNotFoundException exception = assertThrows(
                UserNotFoundException.class, () ->
                        userService.checkAndGetUserByUserId(userId)
        );
    ...
    public void checkUserExistenceByEmail_UnregisteredUser(String email) {
        ...
        UserNotFoundException exception = assertThrows(
                UserNotFoundException.class, () ->
                        userService.checkAndGetUserByEmail(email)
        );
    ...
    public void getUserQuestions(String username) {
        ...
        //Act
        List<UserQuestionResponseDTO> result =
                userService.getUserQuestions(username);
    ...
    public void getUserAnswers(String username) {
        ...
        when(postRepo.findUserAnswerByUsername(username, PostType.ANSWER))
                .thenReturn(answerResponse);

        //Act
        List<UserAnswerResponseDTO> result =
                userService.getUserAnswers(username);
    ...
    public void getUserComments(String username) {
        ...
        when(commentRepo.findUserCommentsByUsername(username))
                .thenReturn(commentResponse);

        //Act
        List<UserCommentResponseDTO> result =
    ...
    public void updateUserDetails_DuplicateUsername(Long currUserId) {
        //Arrange
        UserProfileModificationRequestDTO requestDTO = UserProfileModificationRequestDTO.builder()
                .username("test3")
        ...
        doReturn(userProfile)
                .when(userService)
                .checkAndGetUserByUserId(currUserId);
    ...
    public void updateUserDetails_NoUpdate(Long currUserId) {
        //Arrange
        UserProfileModificationRequestDTO requestDTO = UserProfileModificationRequestDTO.builder()
                .username("test" + currUserId)
                .email("test" + currUserId + "@gmail.com")
                .build();
