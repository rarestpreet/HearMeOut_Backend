...
@Tag(
        name = "Home Feed APIs",
        description = "Endpoints for fetching the main question feed and user summary for the home page"
)
public class HomeController {
    ...
    @Operation(
            ...
            description = "Retrieves a paginated list of recent questions. Incorporates user-specific data like voting status if the user is authenticated."
    )
    @GetMapping("")
    public ResponseEntity<@NonNull List<FeedQuestionResponseDTO>> getQuestions(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(homeServiceImpl
                        .generateFeed(pageNum, userDetails == null ? null : userDetails.getUserId())
                );
    }

    @Operation(
            summary = "Get user summary",
            description = "Fetches a simplified profile summary for the currently authenticated user to display on the home page."
    )
    @GetMapping("profile")
    public ResponseEntity<@NonNull HomeUserProfileResponseDTO> getProfile(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(homeServiceImpl.
                        getUserProfile(userDetails == null ? null : userDetails.getUserId())
                );
    }
}
