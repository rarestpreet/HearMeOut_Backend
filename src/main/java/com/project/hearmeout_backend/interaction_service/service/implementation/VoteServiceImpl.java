...
public class VoteServiceImpl {
  ...
  @Transactional
  public void handleVote(VoteRequestDTO voteRequestDTO, Long userId, VoteType newVoteType)
      throws BadRequestException {
    Vote existingVote =
        voteRepo.findByPostIdAndUserId(voteRequestDTO.getPostId(), userId).orElse(null);
    ...
    if (existingVote == null) {
      ...
      Vote vote = VoteMapper.toVoteEntity(voteRequestDTO, currUser, post, newVoteType);
      voteRepo.save(vote);
