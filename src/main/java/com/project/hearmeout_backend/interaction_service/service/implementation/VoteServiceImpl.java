...
public class VoteServiceImpl {
    ...
    public void handleVote(VoteRequestDTO voteRequestDTO, Long userId) {
        ...
        User currUser = userServiceImpl
                .checkAndGetUserByUserId(userId);
        Post post = postServiceImpl
        ...
        if (existingVote == null) {
            if (newVoteType == VoteType.UPVOTE) {
                author
                        .setReputation(author.getReputation() + 1);
                post
                        .setScore(post.getScore() + 1);
            } else {
                author
                        .setReputation(author.getReputation() - 1);
                post
            ...
            currUser
                    .setReputation(currUser.getReputation() + 1);
            userRepo
                    .save(currUser);
        ...
        VoteType oldVoteType = existingVote
                .getVoteType();
        ...
        if (oldVoteType == newVoteType) {
            ...
            voteRepo
                    .removeVoteByPostIdAndUserId(post.getId(), userId);
