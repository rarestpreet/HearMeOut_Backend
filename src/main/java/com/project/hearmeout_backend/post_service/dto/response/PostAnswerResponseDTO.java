...
public class PostAnswerResponseDTO {
  ...
  @Schema(
      description = "Indicates if the currently authenticated user has cast a vote on this answer")
  ...
  @Schema(
      description =
          "Indicates whether the current authenticated user has permission to edit or delete this answer")
  private boolean operable;

  public PostAnswerResponseDTO(
      Long postId,
