...
public class QuestionPostResponseDTO {
  ...
  @Schema(
      description =
          "Indicates if the currently authenticated user has cast a vote on this question")
  ...
  @Schema(
      description =
          "Indicates whether the current authenticated user has permission to edit or delete this question")
  private boolean operable;

  public QuestionPostResponseDTO(
      Long postId,
